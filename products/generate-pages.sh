...
# 产品页面生成脚本
# 从products.json生成静态产品页面

PRODUCTS_JSON="products.json"
TEMPLATE_FILE="product-template.html"
OUTPUT_DIR="."
...
# 解析JSON并生成页面
# 注意: 这里使用简单的sed替换，实际应该使用jq或Python处理JSON
# 为了简单起见，我们只生成前5个产品页面

echo "从 $PRODUCTS_JSON 读取产品数据..."
